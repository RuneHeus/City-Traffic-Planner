...
object Resources {
  ...
  /** Try's to find a java home directory by either using the environment
    * variable `JAVA_HOME` or the system property `java.home`.
    */
    ...
    javaHome match {
      ...
      case None =>
        throw new FileNotFoundException(
          "$JAVA_HOME is undefined as well as the system property `java.home`." +
