...
package object move: // Anything contained in a "package object" is available at the package-level
  object types:
    ...
    type RectangularNode = ResizableShape
      with RectangleLike
      with ColorizableShape
    type PathNode = ResizableShape with PathLike with ColorizableShape

    /** A valueclass for extending the type Point. This class makes it possible
      * to write:
      * {{{
      *   val point1 = (5,20)
      *   val point2 = (1,1)
      ...
      * }}}
      * see
      * [[http://docs.scala-lang.org/overviews/core/value-classes.html Scala Documentation]]
