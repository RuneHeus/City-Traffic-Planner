...
class SrcFormatDialog extends Alert(AlertType.CONFIRMATION):
  val onelineBtn = new ButtonType(
    Global.fontBundle.getString("srcformat.online-btn")
  )
  val prettyBtn = new ButtonType(
    Global.fontBundle.getString("srcformat.pretty-btn")
  )
