...
class SkeletalParserTest extends MoveSpec:
  ...
  it should "parse basic icons" in {
    ...
    val modelTestExpec =
      Model("test", Icon(None, Nil, NoPosition, NoPosition))
  ...
  it should "parse ellipses" in {
    ...
    iconEqual(
      minimalExp,
      withParseSuccess(graphicModel("ellipse2", minimalEllipse))
    )
  }
      ...
      Icon(
        ...
        List(
          Text(
            ...
            12,
            "Courier",
            Seq("TextStyle.Italic", "TextStyle.Bold"),
            Color.RED,
            "TextAlignment.Left"
          )
        ),
